...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post pessoas_url, params: { pessoa: { cpf: @pessoa.cpf, email: @pessoa.email, name: @pessoa.name, rg: @pessoa.rg, telefone: @pessoa.telefone } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { cpf: @pessoa.cpf, email: @pessoa.email, name: @pessoa.name, rg: @pessoa.rg, telefone: @pessoa.telefone } }
